//********************* Boîte à outils personnelle (C++) ************************
//******************************************************************************
//  LIBRAIRIE : toolbox.cpp  /* changer le nom ! */
//  DATE      :
//  OBJET     :
//  LIMITES   :
//  AUTEUR(S) :
...
//#include "toolbox.hpp"  // créer le fichier d'entête de cette toolbox!
